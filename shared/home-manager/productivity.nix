...

{
  ...
  home.file = {
    ...
    "02-areas/05-templates/README.md".text = ''
  ...
  home.sessionVariables = {
    ...
    INBOX_PICS = "$HOME/02-media/01-pictures/99-inbox";
    ACTIVE_PROJECTS = "$HOME/01-projects";
    BUSINESS_DOCS = "$HOME/02-areas/01-business";
    
    # Obsidian vault locations
    TECH_VAULT = "$HOME/01-documents/01-vaults/00_tech";
    BUSINESS_VAULT = "$HOME/01-documents/01-vaults/01_hwc";
    PERSONAL_VAULT = "$HOME/01-documents/01-vaults/02_personal";
    NIXOS_VAULT = "$HOME/01-documents/01-vaults/03_nixos";
  };
